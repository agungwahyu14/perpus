                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <button id="sidebarToggleTop" class="btn btn-link d-md-none rounded-circle mr-3">
                     ...
                     <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h2 mb-0 text-gray-800 mt-4">Ubah Data Siswa</h1>
                    </div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <input type="hidden" name="id" value="<?php echo $siswa["id"]; ?>">
                            ...
                            <input name="nama" type="text" value="<?= $siswa["nama"]; ?>" class="form-control form-control-user" placeholder="Enter Name" required autofocus autocomplete="off">
                            </div>
                            <div class="form-group">
                            <label for="">Username</label>
                            <input name="username" type="text" value="<?= $siswa["username"]; ?>" class="form-control form-control-user"placeholder="Enter Username" required autofocus autocomplete="off">
                            </div>
                            <div class="form-group">
                            <label for="">Email</label>
                            <input name="email" type="text" value="<?= $siswa["email"]; ?>" class="form-control form-control-user"placeholder="Enter Email" required autofocus autocomplete="off">
                            </div>
                            <div class="form-group">
                             <br>
