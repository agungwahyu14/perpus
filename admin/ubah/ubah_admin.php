                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <button id="sidebarToggleTop" class="btn btn-link d-md-none rounded-circle mr-3">
                     ...
                     <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h2 mb-0 text-gray-800 mt-4">Ubah Data Admin</h1>
                    </div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <input type="hidden" name="id" value="<?php echo $admin["id"]; ?>">
                            ...
                            <input name="nama" type="text" value="<?= $admin["nama"]; ?>" class="form-control form-control-user" placeholder="Enter Name" required autofocus autocomplete="off">
                            </div>
                            <div class="form-group">
                            <label for="">Username</label>
                            <input name="username" type="text" value="<?= $admin["username"]; ?>" class="form-control form-control-user"placeholder="Enter Username" required autofocus autocomplete="off">
                            </div>
                            <div class="form-group">
                             <br>
