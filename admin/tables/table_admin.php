            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h2 mb-0 text-gray-800">Table Admin</h1>
                    </div>
                    ...
                    <table class="table table-bordered table-striped text-center " cellspacing="0">
                                ...
                                <tr>
                                    <td><?= $i++; ?></td>
                                    <td>
                                    <a href="../ubah/ubah_admin.php?id=<?= $row["id"]; ?>" class="btn btn-success">Ubah</a> ||
                                    <a href="../delete/hapus_admin.php?id=<?= $row["id"]; ?>" onclick="return confirm('anda yakin akan menghapus data ini?');" class="btn btn-danger">Hapus</a>
                                    </td>
